...
mixin _$SearchExerciseController on _SearchExerciseControllerBase, Store {
  Computed<List<Exercise>>? _$matchedExercisesComputed;

  @override
  List<Exercise> get matchedExercises => (_$matchedExercisesComputed ??=
          Computed<List<Exercise>>(() => super.matchedExercises,
